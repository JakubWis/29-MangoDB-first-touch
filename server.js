...
mongoose.connect('mongodb+srv://Jacobe:170399@firstcluster-ffspa.mongodb.net/test?retryWrites=true');
...
//czyść bazę danych przed zapisem
const clearDB = function() {
    console.log('DB cleared');
    return User.remove({}, function(err, res) {
        if (err) throw err;
    })
}
